...
الفراعنة حقوق 
تطوير المطور علي @co_od
ownerID = int("5917983447") #ايدي الادمن 
...
- اذا كنت تريد تنصيب ميوزك اختار بايروجـرام ما اذا كان غير ذلك اختر تيليثون .
 - ملاحظـة :
...
async def generator_and_about(app,m):
    ...
    if m.text == "بـايـروجـرام":
        ...
        text += f'🔒 تم حفظ الجلسة في الرسائل المحفوظة قناة البوت @wasit_go'
